...
/* 
 * Questo programma legge tutte le tabelle usate da un package SISS e le scrive in un Excel. Il programma parserizza le query.
 *  Se le query sono troppo complesse da parsarizzare (query innestate) allora viene stampato un warning nella colonna apposita
 *  e viene comunque stampata la query completa nell'excel in modo da poter elaborarla a mano (dove ci sono warning) 
*/

public class UsedTablesAccessPoint {
    ...
    public void run() {  
	    ...
	    for (String file: files) {
			...
			queriesObj.addAll(QueryStringElaborator.computeStringsUsedTablesAP(queries, ambito));
	...
	public static void main(String[] args) {
		...
		UsedTablesAccessPoint acc = new UsedTablesAccessPoint();
